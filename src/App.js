            ...
            <Row>
                ...
                <Col>
                    ...
                    <>
                        ...
                        <h5 className="text-left">Time Elapsed: {this.state.brew.timeElapsed < 0 ? "-" : ""}{Math.floor(Math.max(this.state.brew.timeElapsed, 0) / 60)}:{(Math.abs(Math.floor(this.state.brew.timeElapsed) % 60)).toString().padStart(2, "0")}</h5>
